...
@lazySingleton
class UpdateHargaUseCase implements UseCase<void, HargaEntity> {
  final HargaRepository repository;

  UpdateHargaUseCase(this.repository);

  @override
  Future<Either<NetworkException, void>> execute([HargaEntity? args]) {
    return repository.updateHarga(args!);
  }
}
