...
class RegisterBankSampahScreen extends StatefulWidget {
  ...
  @override
  State<RegisterBankSampahScreen> createState() =>
      _RegisterBankSampahScreenState();
}
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildFormField(
                            label: 'FOTO KEGIATAN',
                            description:
                                'Upload foto kegiatan penimbangan sampah yang valid',
